...
class TestOverviewRecord:
    ...
    def test_indoor_outdoor_parsing(self):
        ...
        record_data = dict(
            tournament_id=1, year=2026, city="Test", circuit=Circuit.TOUR,
            sponsor_title="T", bio=None, singles_draw_size=32, doubles_draw_size=16,
            surface="Clay", surface_detail="", prize="", total_financial_commitment="",
            location="Test, Country", country="Country", event_type="250",
            event_type_detail=0, flag_url="", website="", website_url="",
    ...
    def test_invalid_indoor_value_raises(self):
        with pytest.raises(ValueError, match="Unknown InOutdoor"):
            OverviewRecord(
                tournament_id=1, year=2026, city="Test", circuit=Circuit.TOUR,
                sponsor_title="T", bio=None, singles_draw_size=32, doubles_draw_size=16,
                surface="Hard", surface_detail="", indoor="X",
                prize="", total_financial_commitment="",
                location="Test, Country", country="Country", event_type="250",
                event_type_detail=0, flag_url="", website="", website_url="",
                fb_link="", tw_link="", ig_link="", vixlet_url="",
            )
    ...
    def test_invalid_surface_raises(self):
        with pytest.raises(ValueError):
            OverviewRecord(
                tournament_id=1, year=2026, city="Test", circuit=Circuit.TOUR,
                sponsor_title="T", bio=None, singles_draw_size=32, doubles_draw_size=16,
                surface="Dirt", surface_detail="", indoor="I",
                prize="", total_financial_commitment="",
                location="Test, Country", country="Country", event_type="250",
                event_type_detail=0, flag_url="", website="", website_url="",
                fb_link="", tw_link="", ig_link="", vixlet_url="",
    ...
    def test_model_dump_json_serializes_enums(self):
        ...
        record = OverviewRecord(
            tournament_id=1, year=2026, city="Test", circuit=Circuit.TOUR,
            sponsor_title="T", bio=None, singles_draw_size=32, doubles_draw_size=16,
            surface="Hard", surface_detail="", indoor="I",
            prize="", total_financial_commitment="",
            location="Test, Country", country="Country", event_type="250",
            event_type_detail=0, flag_url="", website="", website_url="",
            fb_link="", tw_link="", ig_link="", vixlet_url="",
